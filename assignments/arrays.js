...
for (let i = 0; i < inventory.length; i++){
  if (inventory[i].id === 33){
    carIdentity = inventory[i];
  }
}
console.log(`Car ${carIdentity.id} is a ${carIdentity.car_year}, ${carIdentity.car_make}, ${ carIdentity.car_model}.`);
...
let oldCars = carYears.filter(isOldEnough);
